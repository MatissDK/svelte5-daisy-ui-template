...
<form method="POST"
      action="/?/setTheme&theme=light&redirectTo={$page.url.pathname}"
      use:enhance={submitUpdateTheme}>

<label class="swap swap-rotate">

        <!-- this hidden button for form submit -->
        <button class="hidden" id="hidden_btn" formaction="/?/setTheme&theme={isDark ? 'light': 'dark'}&redirectTo={$page.url.pathname}"></button>
